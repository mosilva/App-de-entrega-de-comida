package br.com.marcelo.bluefood.application.test;
...
public class InsertDataForTesting {
	...
	public void onAplicationEvent(ContextRefreshedEvent event) {
		...
		Environment environment = event.getApplicationContext().getEnvironment(); // para saber se esta em producao ou test
