...
import br.com.marcelo.bluefood.domain.pagamento.DadosCartao;
import br.com.marcelo.bluefood.domain.pagamento.Pagamento;
import br.com.marcelo.bluefood.domain.pagamento.PagamentoRepository;
import br.com.marcelo.bluefood.domain.pagamento.StatusPagamento;
import br.com.marcelo.bluefood.domain.pedido.Carrinho;
import br.com.marcelo.bluefood.domain.pedido.ItemPedido;
import br.com.marcelo.bluefood.domain.pedido.ItemPedidoPK;
import br.com.marcelo.bluefood.domain.pedido.ItemPedidoRepository;
import br.com.marcelo.bluefood.domain.pedido.Pedido;
import br.com.marcelo.bluefood.domain.pedido.Pedido.Status;
...
public class PedidoService {
	...
	public Pedido criarEPagar(Carrinho carrinho, String numCartao) throws PagamentoException {
		...
		try {
			...
			throw new PagamentoException("Erro no servidor do pagamento");
		}
